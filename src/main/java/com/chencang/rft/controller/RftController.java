...
public class RftController {
    ...
    public void AutoTest(@RequestParam String plat,@RequestParam String projectId,@RequestParam String testRunId) {
        String pathHttp = "";
        ...
        if (plat.contains("rft")) {
            try {
                ...
                List<String> result = FileUtil.readTxt(rftConfig.getPolarionTxt()+"/scriptName.txt");
                result.removeAll(Collections.singleton(null));
                String[] scriptNames = result.get(0).split(":");
            ...
            List<String> result = FileUtil.readTxt(lpath+"/scriptName.txt");
            result.removeAll(Collections.singleton(null));
            String[] scriptNames = result.get(0).split(":");
            String scriptName = scriptNames[1];
            String[] name = scriptName.substring(1, scriptName.length() - 1).split(",");
